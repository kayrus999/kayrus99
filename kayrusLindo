...
local redzlib = {
	...
	["Color Stroke"] = Color3.fromRGB(90, 30, 140),
...
Blue = {
	...
	["Color Text"] = Color3.fromRGB(255, 255, 255),
	["Color Dark Text"] = Color3.fromRGB(255, 255, 0),
	["Color Dark Blue"] = Color3.fromRGB(0, 0, 255),
	["Color Hub 9"] = Color3.fromRGB(0, 0, 0),
	["Color Yellow"] = Color3.fromRGB(0, 0, 255)
}
	},
	Info = {
		Version = "1.2.0"
...
function redzlib:MakeWindow(Configs)
	...
	function Window:CloseBtn()
		local Dialog = Window:Dialog({
			Title = "Close",
			Text = "Deseja realmente fechar o Lyra Hub? Ele contém recursos essenciais e fechar agora pode interromper funções importantes, causar falhas ou perder suas configurações. Cuidado antes de prosseguir!",
			Options = {
				{"Confirm", function()
					ScreenGui:Destroy()
				end},
	...
	function Window:MakeTab(paste, Configs)
		...
		function Tab:AddDiscordInvite(Configs)
			...
			if Logo ~= "" then
				Make("Stroke", ServerIcon, nil, Color3.fromRGB(0, 0, 0), 2.2)
			end
			...
			if MembersOnline > 0 or TotalMembers > 0 then
				...
				if MembersOnline > 0 then
					CreateStatusIndicator(Color3.fromRGB(255, 255, 255), MembersOnline .. " Online")
				end
				
				if TotalMembers > 0 then
					CreateStatusIndicator(Color3.fromRGB(255, 255, 255), TotalMembers .. " Members")
				end
			end
